...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_cute_timeline__ = __webpack_require__(85);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getUrl: function getUrl(image) {
            console.log(image.src.replace('zip_image', 'img'));
            return image.src.replace('zip_url', 'url');
        },
        ...
        setData: function setData(data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                if (b_auto) this.testData.push({ data: one_item, items: [item_data] });
            }
        },
