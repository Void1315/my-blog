...
module.exports = {
	data: function data() {
		return {
			articleData: [{ id: 5, title: "sssa", deleted_at: null, created_at: "2018-08-23 10:33:54" }]
		};
	},
	methods: {
    ...
    [
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _c("el-table-column", {
            attrs: { prop: "deleted_at", label: "日期", width: "180" }
          }),
          _vm._v(" "),
          _c("el-table-column", {
            attrs: { prop: "created_at", label: "日期", width: "180" }
          })
        ],
        1
      )
