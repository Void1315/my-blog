    ...
    methods: {
        ...
        setData: function setData(data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                console.log(String(item_time.getDate()).length);
                var month = item_time.getMonth().length > 1 ? item_time.getMonth() + 1 : "0" + (item_time.getMonth() + 1);
                var day = item_time.getDate().length >= 2 ? item_time.getDate() : "0" + item_time.getDate();
