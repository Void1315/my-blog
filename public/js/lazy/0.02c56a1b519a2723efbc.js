...
module.exports = {
	...
	methods: {
		...
		handleInputConfirm: function handleInputConfirm() {
			...
			if (inputValue) {
				if (this.form.tages.indexOf(inputValue) == -1) this.form.tages.push(inputValue);else {
...
var update = __webpack_require__(1)("7374be22", content, false, {});
