...
var update = __webpack_require__(1)("765c975a", content, false, {});
	...
	methods: {
		...
		articleDelete: function articleDelete(index, id) {
			...
			this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
				...
				_this.$ajax.get("/admin/article/solid/delete/" + id).then(function (res) {
					_this.recycleleData.splice(index, 1);
					_this.$message({
						type: 'success',
						message: '删除成功!'
					});
				}).catch(function (error) {
					_this.$message.warning("出现了一些错误请稍后再试!");
                  ...
                  return [
                      ...
                      "el-button",
                      {
                        ...
                        on: {
                          click: function($event) {
                            return _vm.articleEdit(scope.$index, scope.row.id)
                          }
                        }
                      },
                      [_vm._v("编辑")]
                    ...
                    _c(
                      "el-button",
                      {
                        ...
                        on: {
                          click: function($event) {
                            return _vm.articleDelete(scope.$index, scope.row.id)
                          }
                        }
                      },
                      [_vm._v("删除")]
