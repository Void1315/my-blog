...
var update = __webpack_require__(1)("372205d7", content, false, {});
                  ...
                  return [
                      ...
                      "el-button",
                      {
                        ...
                        on: {
                          click: function($event) {
                            return _vm.handleEdit(scope.$index, scope.row.id)
                          }
                        }
                      },
                      [_vm._v("编辑")]
                    ...
                    _c(
                      "el-button",
                      {
                        ...
                        on: {
                          click: function($event) {
                            return _vm.handleDelete(scope.$index, scope.row.id)
                          }
                        }
                      },
                      [_vm._v("删除")]
