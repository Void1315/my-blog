...
var update = __webpack_require__(2)("19a91e30", content, false, {});
	...
	data: function data() {
		return {
			data: [{
				id: "1",
				title: "Test",
				text: "<p>aaaaaaaa</p><p>bbbb</p>",
				assent: 0,
				img_url: "",
				created_at: "2016-0116 20:55",
				tages: ["php", "java", "python"]
			}, {
				id: "2",
				title: "Test",
				text: "<p>aaaaaaaa</p><p>bbbb</p>",
  ...
  return _c(
    ...
    [
      _vm._l(_vm.data, function(article) {
        return _c("article-over", { attrs: { article: article } })
      }),
      _vm._v(" "),
