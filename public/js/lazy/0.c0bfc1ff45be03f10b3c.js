...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        setData: function setData(data) {
            ...
            // this.testData.push({data:one_item,items:[]})
            for (var i = 0; i < data.length; i++) {
                ...
                //     this.testData.data = new Object();
                //     this.testData.items = new Array()

                // }
                var index_ = i;
                if (this.testData.length == 0) this.testData.push({ data: one_item, items: [] });
                for (var j = 0; j < this.testData.length; j++) {
                    if (this.testData[j].data == one_item) {
                        index_ = j;
                    } else this.testData.push({ data: one_item, items: [] });
                }
                ...
                this.testData[index_].items.push(item_data);
            }
        }
    },
    mounted: function mounted() {
        ...
        this.$nextTick(function () {
            ...
            // console.log(JSON.stringify(this.trueJson))
