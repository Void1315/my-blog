    ...
    methods: {
        ...
        setData: function setData(data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                this.testData[one_item].items.push({ itemData: one_time, partImg: data[i].images, text: data[i].info });
                // console.log(item_data)
            }
            // var item_data = new Object();
            // item_data.itemData = 1
            // item_data.partImg = 1
            // item_data.text = 1
            // this.testData["2018-09"].items.push(item_data)
