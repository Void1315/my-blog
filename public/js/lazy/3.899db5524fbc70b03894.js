...
var update = __webpack_require__(2)("a60fc11a", content, false, {});
...
module.exports = {
	...
	methods: {
		...
		initContent: function initContent(event) {
  ...
  return _c(
    ...
    [
      _c("left-windows", {
        ...
        on: { switchContent: _vm.switchContent, initContent: _vm.initContent }
      }),
      _vm._v(" "),
      _c(
        "div",
