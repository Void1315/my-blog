	...
	<div>
		<el-form ref="form" :model="form" label-width="80px">
			...
			<el-form-item label="上传" prop="imageList">
				<el-upload action="/create/image" :on-preview="handlePreview" :on-remove="handleRemove" :on-success="handSuccess" :file-list="form.imageList" :data="img_data" :multiple="true" name="img" list-type="picture">
...
module.exports = {
	...
	methods: {
		...
		submitForm() {
			this.$ajax.post("/create/imgitem", this.form).then((response) => {
				this.$message({
          message: '成功上传图片！',
          type: 'success'
        });
